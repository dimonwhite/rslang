const choice = {
  ru: {
    ...
    v: [
      ...
      ['обалдеть', 'обвалиться', 'обвести', 'обветрить', 'обветшать', 'обвешать', 'обвинить', 'обвинять', 'обвиняться', 'обвиснуть', 'обвить', 'обводить', 'обворовать', 'обвязать', 'обойти'],
    ...
    n: [
      ...
      ['бабай', 'банка', 'ботинок', 'бочка', 'бабочка', 'бабуин', 'бинокль', 'бант', 'бабушка', 'багаж', 'багажник', 'багор', 'багрец', 'бадан', 'бадья', 'базар', 'базис', 'байдарка', 'байка', 'байрам'],

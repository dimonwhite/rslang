const choice = [
'j':[
['абсолютный', 'абсурдный', 'абхазский', 'авантюрный', 'аварийный', 'автобусный', 'автоматный', 'автономный', 'авторский', 'агатовый', 'агентурный', 'аграрный', 'адекватный', 'адовый', 'адресный'],
...
['казать', 'казаться', 'казнить', 'казниться', 'какать', 'калечить', 'каменеть', 'кануть', 'канючить', 'капать', 'капнуть', 'карать', 'караться', 'караулить', 'каркать'],
...
['давило', 'давка', 'давление', 'давность', 'дагестанец', 'дальность', 'дальтоник', 'дамба', 'дамка', 'дамочка', 'данность', 'дантист', 'дармоед', 'дарование', 'датчанин', 'датчик', 'дачка', 'дачник', 'двадцатка', 'дверка'],
...
['мавзолей', 'магазин', 'магазинчик', 'магистр', 'магистраль', 'магистрат', 'магия', 'магнат', 'магнезия', 'магнетизм', 'магний', 'магнит', 'магнитофон', 'магнолия', 'мадам', 'мадонна', 'мажор', 'мазанка', 'мазок', 'мазохизм'],
...
['павиан', 'павильон', 'павлин', 'паводок', 'пагода', 'падаль', 'падение', 'падло', 'падчерица', 'пазуха', 'пайка', 'пайщик', 'пакгауз', 'пакет', 'пакетик', 'пакля', 'пакостник', 'пакость', 'паладин', 'паланкин'],
...
['убеждение', 'убежище', 'убийство', 'убийца', 'убитый', 'ублюдок', 'убогость', 'убожество', 'уборка', 'уборная', 'уборщик', 'уборщица', 'убранство', 'убыль', 'убыток', 'уважение', 'увалень', 'увеличение', 'уверение', 'увертюра'],
...
['ябеда', 'яблоко', 'яблонька', 'яблоня', 'яблочко', 'яблочник', 'явление', 'ягель', 'ягненок', 'ягода', 'ягодица', 'ягодка', 'язычник', 'язычок', 'яичко', 'яичник', 'яичница', 'якорь', 'ямочка', 'ямщик'],
],
'other':

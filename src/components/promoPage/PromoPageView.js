  ...
  create() {
    ...
    this.main.innerHTML = `
      ...
      <div class="promoPage__desc">
        ...
        то данный алгоритм будет повторяться заново, что гарантирует достижение результата в изучении. Для закрепления изученных слов и изучения новых, присутствует 

  ...
  create() {
    ...
    this.main.innerHTML = `
      ...
      <div class="promoPage__desc">
        ...
        слово будет повторяться на следующий день, затем ещё раз на следующий день, далее интервал повторения будет каждый раз удваиваться. Если допустите ошибку, то данный алгоритм будет повторяться заново, что гарантирует достижение результата в изучении. Для закрепления изученных слов и изучения новых, присутствует 6 различных красочных игр, в которых вам проверить себя в  написании, аудировании и произношении английских слов. Это поможет сделать обучение английскому языку весёлым и захватывающим.
      </div>

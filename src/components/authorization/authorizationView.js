...
export default class AuthorizationModel {
  constructor() {
    ...
    this.popUp = createElement({
      tag: 'div',
      class: 'pop-up',
      content: `<svg class="login-form__close close-icon" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  createSignIn() {
    ...
    this.form = createElement({ tag: 'form', class: 'form-signIn' });
    this.form.setAttribute('enctype', 'text/plain');
    this.form.setAttribute('method', 'POST');

    this.formLogin = createElement({ tag: 'input', class: 'form-signIn__input form-signIn__login' });
    this.formLogin.setAttribute('type', 'text');
    this.formLogin.setAttribute('name', 'login');
    this.formLogin.setAttribute('placeholder', 'Login');

    this.formPassword = createElement({ tag: 'input', class: 'form-signIn__input form-signIn__password' });
    ...
    this.formSubmit = createElement({ tag: 'input', class: 'form-signIn__submit' });
    ...
    this.formBtn = createElement({ tag: 'div', class: 'form-signUp__link', content: 'Регистрация' });
  ...
  createSignUp() {
    ...
    this.form = createElement({ tag: 'form', class: 'form-signUp' });
    this.form.setAttribute('enctype', 'text/plain');
    this.form.setAttribute('method', 'POST');

    this.formLogin = createElement({ tag: 'input', class: 'form-signUp__input form-signUp__login' });
    this.formLogin.setAttribute('type', 'text');
    this.formLogin.setAttribute('name', 'login');
    this.formLogin.setAttribute('placeholder', 'Login');

    this.formPassword = createElement({ tag: 'input', class: 'form-signUp__input form-signUp__password' });
    this.formPassword.setAttribute('type', 'password');
    this.formPassword.setAttribute('name', 'password');
    this.formPassword.setAttribute('placeholder', 'Password');

    this.formSubmit = createElement({ tag: 'input', class: 'form-signUp__submit' });
    this.formSubmit.setAttribute('type', 'submit');
    this.formSubmit.setAttribute('value', 'Отправить');
    ...
    this.formBtn = createElement({ tag: 'div', class: 'form-signUp__link', content: 'Войти' });
